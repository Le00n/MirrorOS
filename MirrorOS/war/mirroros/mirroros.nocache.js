...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "mirroros" because\n';
  ...
  $wnd.__gwt_activeModules['mirroros'] = {
    'moduleName' : 'mirroros',
    'bindings' : function() {
      return {};
    }
 ...
 * "/mirroros.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['mirroros'].superdevmode = true;

  var expectedSuffix = '/mirroros.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + mirroros + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:mirroros';
  var devModeSessionKey = '__gwtDevModeSession:mirroros';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/mirroros/mirroros.nocache.js';
  ...
  $wnd.__gwt_activeModules['mirroros'].canRedirect = true;
  $wnd.__gwt_activeModules['mirroros'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/mirroros?user.agent=' + ua + '&_callback=' + callback;
